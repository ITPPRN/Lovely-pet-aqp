...
class UpdateRoomBooking extends StatefulWidget {
  final String? token;
  final int? idBooking;
  ...
  @override
  State<UpdateRoomBooking> createState() => _UpdateRoomBookingState();
}

class _UpdateRoomBookingState extends State<UpdateRoomBooking> {
